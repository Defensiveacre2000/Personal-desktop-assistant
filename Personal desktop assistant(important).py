...
label = Label(root , text = "Welcome to personal desktop assistant" , bg = "Light Blue" , font = ("Comfortaa" , 15 , "bold"))
...
btn = Button(root , text = "Start" , bg = "red3" , fg = "white" , padx = 10 , pady = 1 , font = ("Comfortaa" , 11 , "bold") , relief = FLAT , command = r_audio)
